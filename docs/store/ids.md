...
- Achievement ids: 20 of the 80 local achievements are mirrored to Play Games; the map is `PLAY_ACHIEVEMENT_IDS` in `src/platform/gameIds.ts` (created 2026-09-20 by ZIP import, ids `CgkIi5ONn5EeEAIQ…`)
